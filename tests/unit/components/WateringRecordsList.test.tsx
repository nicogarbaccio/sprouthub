...
describe('WateringRecordsList', () => {
  ...
  describe('visual elements and styling', () => {
    it('should apply correct CSS classes for layout', () => {
      ...
      const container = screen.getByRole('list', { hidden: true }).parentElement;
      expect(container).toHaveClass('space-y-4');

      // Check individual record containers
      const recordContainers = container?.querySelectorAll('.border.rounded-lg');
    ...
    it('should show proper trash icon classes when not loading', () => {
      ...
      const icons = screen.container.querySelectorAll('svg:not(.animate-spin)');
    ...
    it('should render separators between records correctly', () => {
      ...
      const separators = screen.container.querySelectorAll('.border-b');
  ...
  describe('responsive design', () => {
    it('should have responsive text sizing classes', () => {
      ...
      const dateElements = screen.container.querySelectorAll('.font-medium');
      dateElements.forEach(element => {
        expect(element).toHaveClass('text-base', 'sm:text-sm');
      });

      // Check for responsive text classes on notes
      const noteElements = screen.container.querySelectorAll('.text-muted-foreground');
    ...
    it('should have responsive padding classes', () => {
      ...
      const recordContainers = screen.container.querySelectorAll('.p-4.sm\\:p-3');
      expect(recordContainers).toHaveLength(3);
    });
  });
  ...
  describe('edge cases', () => {
    ...
    it('should handle records with very long notes', () => {
      const recordWithLongNotes = [{
        ...
        watered_at: '2025-01-15T10:00:00Z',
        notes: 'This is a very long note that might wrap to multiple lines and should be handled gracefully by the component layout without breaking the design or functionality of the watering records list component.'
      }];
