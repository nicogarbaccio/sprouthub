    ...
    >
        ...
        <div className="flex items-center space-x-2">
          {plantName && (
            <h2
              ...
              className="text-white text-lg font-medium font-poppins"
            >
              {plantName}
            </h2>
          )}
      ...
      {showMobileHint && (
        <div
          ...
          onClick={(e) => e.stopPropagation()}
        >
          <div className="bg-black/70 text-white text-sm px-4 py-2 rounded-full backdrop-blur-sm animate-fade-in">
