...
const Toaster = ({ ...props }: ToasterProps) => {
 ...
 <Sonner
  ...
  classNames: {
   ...
   info:
   "group-[.toaster]:bg-sprout-water/10 group-[.toaster]:border-sprout-water/30 group-[.toaster]:text-sprout-water dark:group-[.toaster]:bg-sprout-water/20 dark:group-[.toaster]:border-sprout-water/40",
  },
  style: {
